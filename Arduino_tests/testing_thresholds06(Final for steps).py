...
STEP_THRESHOLD = 0.2  # Initial threshold for peak detection
PEAK_HEIGHT_THRESHOLD = 0.5  # Minimum height for a peak
MIN_TIME_BETWEEN_STEPS = 200  # Minimum time to wait after a step is counted in milliseconds
...
THRESHOLD_GAP = 2  # Gap between SMA and upper threshold
LOWER_THRESHOLD_GAP = 1.5  # Gap between SMA and lower threshold
